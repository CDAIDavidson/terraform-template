...
resource "aws_subnet" "public" {
  ...
  tags = merge(var.tags, {
    Name = "${var.account_name}-public-subnet-${count.index + 1}"
    Type = "Public"
  })
}
...
resource "aws_subnet" "private" {
  ...
  tags = merge(var.tags, {
    Name = "${var.account_name}-private-subnet-${count.index + 1}"
    Type = "Private"
  })
}
...
resource "aws_nat_gateway" "main" {
  ...
  tags = merge(var.tags, {
    Name = "${var.account_name}-nat-gateway-${count.index + 1}"
  })
...
resource "aws_vpn_gateway" "main" {
  ...
  tags = merge(var.tags, {
    Name = "${var.account_name}-vpn-gateway"
  })
}
