...
# Stage 3: Parameter Store Terraform Apply Script
# This script sets up the environment and runs terraform apply

echo "🚀 Starting Stage 3: Parameter Store Apply"
...
echo "🎉 Apply complete! Your Parameter Store items are now created!"
