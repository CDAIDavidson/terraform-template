...
# Networking Module Terraform Apply Script
# This script sets up the environment and runs terraform apply

set -e  # Exit on any error

echo "🚀 Starting Networking Module Apply"
...
echo "🎉 Apply complete! Your networking infrastructure is now created!"
echo "📝 Note the VPC and subnet IDs from the outputs - you'll need them for other modules"
