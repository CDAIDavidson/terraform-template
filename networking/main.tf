...
# This module creates a complete VPC setup with public/private subnets, NAT gateways, and routing
...
resource "aws_route_table" "private" {
  count = var.enable_nat_gateway ? local.subnet_count : 1
...
# Security Group for default access
